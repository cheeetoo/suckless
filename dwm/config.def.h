...
static const char col_green[] = "#1e573c";
...
static const char *mpvcmd[] = {"/bin/sh", "-c", "umpv $(xclip -o)", NULL};

static const char *ytcmd[] = {
    "/bin/sh", "-c", "umpv $(ytfzf -D -L $(echo -n | dmenu -p Search:))", NULL};
